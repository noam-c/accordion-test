This project is an implementation of jQuery's Accordion widget on a test page. The test page accordion is populated with data from a PHP page (currently just the date and time).
